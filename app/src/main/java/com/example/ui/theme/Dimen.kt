...
data class AppDimens(
    ...
    /** Начальный правый отступ контента в редакторе (0.dp обеспечивает константную максимальную ширину поля ввода при росте карточки и плавный сдвиг влево на 8dp) */
    val taskEditorCollapsedEndPadding: Dp = 0.dp,
